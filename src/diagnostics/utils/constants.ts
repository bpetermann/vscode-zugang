...
export const NUMERIC_LITERAL = 'NumericLiteral' as const;
export const BOOLEAN_LITERAL = 'BooleanLiteral' as const;
export const TEMPLATE_LITERAL = 'TemplateLiteral' as const;
export const JSX_EXPRESSION_CONTAINER = 'JSXExpressionContainer' as const;
